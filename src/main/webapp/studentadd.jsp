...
<body>
 <form class="layui-form   layui-form-pane" action="">
     ...
     <div class="layui-form-item">
         ...
         <div class="layui-input-block">
             <input type="text" name="grade" required lay-verify="required" placeholder="请输入年级" autocomplete="off" class="layui-input"  >
         </div>
     </div>
     <div class="layui-form-item">
     ...
     <div class="layui-form-item">
         ...
         <div class="layui-input-block">
             <input type="text" name="identityCode" required lay-verify="required" placeholder="请输入身份证" autocomplete="off" class="layui-input"  >
         </div>
     </div>
     <div class="layui-form-item">
         <div class="layui-input-block">
...
layui.use(['form', 'jquery','laydate'], function(){
    ...
    laydate.render({
	  ...
	  form.on('submit(submitButton)', function(data){
	    ...
	    $.ajax({
	    	url: '${pageContext.request.contextPath}/competitionTeamAddStuServlet',
	    	method: 'GET',
