  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item">
          <a href="javascript:;" arget="content" class="layui-icon layui-icon-user" style="font-size: 16px; color: #1E9FFF">教师使用列表</a>
          <dl class="layui-nav-child layui-nav-itemed">
<%--              <dd><a href="../table/userlist.jsp" target="content">教师信息</a></dd>--%>
            <dd><a href="teacherChecklist.jsp" target="content">审核</a></dd>
          </dl>
        </li>
      </ul>
    </div>
